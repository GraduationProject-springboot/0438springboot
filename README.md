...
![](/md/blog.006.png "IMG\_256")
校园论坛实体属性图

（2）下图是每日健康填报实体和其具备的属性。

![](/md/blog.007.png "IMG\_257")
每日健康填报实体属性图

（3）下图是教师实体和其具备的属性。

![](/md/blog.008.png "IMG\_258")
教师实体属性图

（4）下图是体检服务实体和其具备的属性。

![](/md/blog.009.png "IMG\_259")
体检服务实体属性图

（5）下图是体检预约实体和其具备的属性。

![](/md/blog.010.png "IMG\_260")
体检预约实体属性图

（6）下图是服务留言实体和其具备的属性。

![](/md/blog.011.png "IMG\_261")
服务留言实体属性图

（7）下图是驿站收藏实体和其具备的属性。

![](/md/blog.012.png "IMG\_262")
驿站收藏实体属性图

（8）下图是校园健康资讯实体和其具备的属性。

![](/md/blog.013.png "IMG\_263")
校园健康资讯实体属性图

（9）下图是健康驿站实体和其具备的属性。

![](/md/blog.014.png "IMG\_264")
健康驿站实体属性图

（10）下图是自测异常信息实体和其具备的属性。

![](/md/blog.015.png "IMG\_265")
自测异常信息实体属性图

（11）下图是学生实体和其具备的属性。

![](/md/blog.016.png "IMG\_266")
学生实体属性图

（12）下图是服务收藏实体和其具备的属性。

![](/md/blog.017.png "IMG\_267")
服务收藏实体属性图

（13）下图是驿站留言实体和其具备的属性。

![](/md/blog.018.png "IMG\_268")
驿站留言实体属性图

（14）下图是学生请假实体和其具备的属性。

![](/md/blog.019.png "IMG\_269")
学生请假实体属性图
###
### 4.3.2 数据库物理设计
